...
//                 },
//                 handler: async function () {
//   // 3 second wait, phir retry karo agar pehli baar fail ho
//   let attempts = 0;
...
//         navigate("/subscription-status", {
//           replace: true,
//           state: { membershipType: res.data.membershipType },
//         });
//         setLoadingTier(null);
//       } else if (attempts < 5) {
//         // 3 second baad phir try karo, max 5 attempts
