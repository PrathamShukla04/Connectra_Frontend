...
//                         className={`mx-auto mb-5 flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full ${accent.iconBg}`}
//                     >
//                         {isGold ? (
...
//                         You are a {isGold ? 'Gold' : 'Silver'} Member!
//                     </h1>
