    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-[0_20px_60px_rgba(0,0,0,0.6)] space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-indigo-300 mb-2">Digital Services Only</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold text-indigo-300 mb-2">Delivery Time</h2>
            <p className="text-indigo-200/70 text-sm leading-relaxed">
              Once your payment is successfully completed, access credentials
              or activation details are delivered to your registered email within 1 hour.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-semibold text-indigo-300 mb-2">Delay or Issues</h2>
            <p className="text-indigo-200/70 text-sm leading-relaxed">
              If you experience any delay in receiving your access details,
              please contact our support team immediately.
            </p>
            <p className="text-indigo-300 font-medium mt-2">support@connectra.com</p>
          </div>
